...
class DualMerger(TaskVectorBasedMerger):
    ...
    def merge(self, base_model, finetuned_models):
        ...
        print(ordered_keys)
        module_net  = build_duality_map_my(ordered_keys, multi_task_vector_cpu)
        
        module_foo = build_duality_map(ordered_keys, multi_task_vector_cpu, self.device)  # ← add self.device
